...
const TerraformCode = () => {
  ...
  const terraformLines = [
    ...
    { code: '    Name         = "Kim Sejoon"', type: 'attribute' },
    { code: '    Role         = "DevOps Engineer"', type: 'attribute' },
    { code: '    Skills       = ["AWS", "Kubernetes", "Terraform"]', type: 'attribute' },
    { code: '    Certifications = [', type: 'list' },
    { code: '      "AWS DevOps Professional",', type: 'list-item' },
    { code: '      "Kubernetes CKA",', type: 'list-item' },
    { code: '      "Azure Solutions Architect"', type: 'list-item' },
    { code: '    ]', type: 'close' },
    ...
    { code: '    github   = "github.com/kimsejoon"', type: 'attribute' },
    { code: '    linkedin = "linkedin.com/in/kimsejoon"', type: 'attribute' },
    { code: '    email    = "kimsejoon@example.com"', type: 'attribute' },
    { code: '  }', type: 'close' },
    { code: '}', type: 'close' },
  ];
